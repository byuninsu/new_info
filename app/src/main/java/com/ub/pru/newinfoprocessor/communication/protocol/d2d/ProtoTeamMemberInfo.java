...
public class ProtoTeamMemberInfo implements IProto {

    private static final String TAG = "ProtoTeamMemberInfo";
    private byte mType = Define.PROTOCOL_ID_TEAM_MEMBER_INFO;
    private TransportPacket mTransportPacket;
